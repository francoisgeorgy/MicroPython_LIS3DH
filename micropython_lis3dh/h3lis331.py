...
# Data rate (CTRL_REG1)
DATARATE_1000 = const(0b11)  # 1000 Hz
DATARATE_400 = const(0b10)  # 400Hz
# DATARATE_200 = const(0b0110)  # 200Hz
DATARATE_100 = const(0b01)  # 100Hz
DATARATE_50 = const(0b00)  # 50Hz
...
# Data Range
DATARANGE_100 = const(0b00)  # +/- 100G
DATARANGE_200 = const(0b01)  # +/- 200G
# DATARANGE_8 = const(0b10)  # +/- 8g
DATARANGE_400 = const(0b11)  # +/- 400G
...
FILTER_MODE_NORMAL = const(0b00)
FILTER_MODE_REFERENCE = const(0b01)
# FILTER_MODE_NORMAL2 = const()
FILTER_COEFF_1 = const(0b00)
FILTER_COEFF_2 = const(0b01)
FILTER_COEFF_3 = const(0b10)
FILTER_COEFF_4 = const(0b11)

class H3LIS331:
    """Main class for the Sensor

    :param ~machine.I2C i2c: The I2C bus the H3LIS331 is connected to.
    ...
    **Quickstart: Importing and using the device**
    ...
    Here is an example of using the :class:`h3lis331.H3LIS331` class.
    First you will need to import the libraries to use the sensor

    .. code-block:: python

        from machine import Pin, I2C
        from micropython_h3lis331 import h3lis331
    ...
    .. code-block:: python
        ...
        acc_x, acc_y, acc_z = h3lis331.acceleration
    ...
    _axes_enabled = CBits(3, _REG_CTRL1, 0)  # Zen|Yen|Xen
    _data_rate = CBits(2, _REG_CTRL1, 3)  # DR1|DR0
    ...
    # HPCF[1:0]
    _filter_coeff = CBits(2, _REG_CTRL2, 0)
    ...
    def axes_enabled(self):
        ...
        | Mode                                       | Value                   |
        +============================================+=========================+
        | :py:const:`h3lis331.AXES_X`                  | :py:const:`0b001`       |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.AXES_Y`                  | :py:const:`0b010`       |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.AXES_X_Y`                | :py:const:`0b011`       |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.AXES_Z`                  | :py:const:`0b100`       |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.AXES_Z_X`                | :py:const:`0b101`       |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.AXES_Z_Y`                | :py:const:`0b110`       |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.AXES_Z_Y_X`              | :py:const:`0b111`       |
        +--------------------------------------------+-------------------------+
    ...
    def data_rate(self):
        ...
        | Mode                                       | Value                   |
        +============================================+=========================+
        | :py:const:`h3lis331.DATARATE_1`              | :py:const:`0b0001`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_10`             | :py:const:`0b0010`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_25`             | :py:const:`0b0011`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_50`             | :py:const:`0b0100`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_100`            | :py:const:`0b0101`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_200`            | :py:const:`0b0110`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_400`            | :py:const:`0b0111`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_1344`           | :py:const:`0b1001`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_POWERDOWN`      | :py:const:`0b0000`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_LOWPOWER_1600`  | :py:const:`0b1000`      |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARATE_LOWPOWER_5000`  | :py:const:`0b1001`      |
        +--------------------------------------------+-------------------------+
    ...
    @property
    def data_range(self):
        """The range of the accelerometer. The H3LIS331 has dynamically user
        ...
        | Mode                                       | Value                   |
        +============================================+=========================+
        | :py:const:`h3lis331.DATARANGE_2`             | :py:const:`0b00`        |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARANGE_4`             | :py:const:`0b01`        |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARANGE_8`             | :py:const:`0b10`        |
        +--------------------------------------------+-------------------------+
        | :py:const:`h3lis331.DATARANGE_16`            | :py:const:`0b11`        |
        +--------------------------------------------+-------------------------+
